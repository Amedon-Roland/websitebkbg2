...
{{--
    ...
    Exemple d'utilisation :
        ...
        />
--}}
<div class="relative w-full max-w-[1272px] h-[653px] overflow-hidden">
    {{-- Background Image --}}
    <img src="{{ $image }}" alt="Landscape Image" class="w-[1270px] h-[570px] rounded-[40px] object-cover">

    {{-- Content Overlay --}}
    <div class="absolute bottom-0 left-1/2 mb-4 transform -translate-x-1/2 bg-white w-[790px] h-[230px] rounded-[20px] p-8 shadow-lg shadow-gray-500/25">
        {{-- Red Bar --}}
        <div class="absolute top-0 left-0 w-full h-[20px] bg-primary rounded-t-[20px]"></div>

        {{-- Title --}}
        <h3 class="text-2xl font-medium font-raleway text-primary mb-4 text-center">{{ $title }}</h3>
