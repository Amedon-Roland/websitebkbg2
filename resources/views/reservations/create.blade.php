                                ...
                                <div class="form-control w-full mt-3">
                                    ...
                                    <div class="dropdown w-full">
                                        <div tabindex="0" role="button" class="select select-bordered w-full flex justify-between items-center">
                                            <span id="selected-room-text">Attribuer automatiquement</span>
                                        ...
                                        <ul tabindex="0" class="dropdown-content z-[1] menu p-2 shadow bg-base-100 rounded-box w-full max-h-60 overflow-y-auto">
                                            <li><a data-value="" class="room-option active">Attribuer automatiquement</a></li>
                                            @foreach($availableRooms as $room)
                                                <li><a data-value="{{ $room->id }}" class="room-option">Chambre n° {{ $room->room_number }}</a></li>
                                            @endforeach
                                        </ul>
                                    </div>
